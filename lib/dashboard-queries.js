...
const PIPELINE_CONFIG = {
  ...
  freescout: { displayName: 'FreeScout', description: 'Members from Rondo Club to FreeScout customers' },
  teams: { displayName: 'Teams', description: 'Teams and team work history from Sportlink to Rondo Club' },
  functions: { displayName: 'Member roles + VOG', description: 'Committees, roles, VOG dates from Sportlink to Rondo Club' },
  'functions-full': { displayName: 'Functions (full)', description: 'Full sync of all member roles, committees, VOG, and invoice data' },

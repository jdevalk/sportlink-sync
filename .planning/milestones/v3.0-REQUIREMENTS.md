# Requirements Archive: 3.0 Web Dashboard
...
- [x] **EMAIL-01**: Email reports sent only when errors occur (replace always-send)
- [x] **EMAIL-02**: Error emails include a link to the relevant run detail in the dashboard
...
| EMAIL-01 | Phase 38 | Complete |
| EMAIL-02 | Phase 38 | Complete |
